...
METHODOLOGY_REGISTRY = {
    ("P", "architecture"): ["adr-first", "brainstorming"],
    ("P", "spike"): ["spike-and-stabilize"],
    ("P", "decompose"): ["writing-plans"],
    ("P", "research"): ["brainstorming"],
    ("P", "plan"): ["writing-plans", "brainstorming"],
    ("D", "implement"): ["tdd", "subagent-dev"],
    ("D", "design"): ["adr-first", "subagent-dev"],
    ("D", "configure"): [],
    ("D", "explore"): [],
    ("C", "review"): ["code-review"],
    ("C", "verify"): ["verify"],
    ("C", "evaluate"): ["systematic-debugging"],
    ("C", "audit"): ["systematic-debugging"],
    ("A", "standardize"): ["finish-branch"],
    ("A", "merge"): ["finish-branch"],
    ("A", "reflect"): [],
    ("A", "document"): [],
}
